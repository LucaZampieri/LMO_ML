...
# Ouput directory
saving_path = 'tobesure/' # predictions will be saved in ./output/saving_path
model_path = 'tobesure/' # the model will be saved in ./unet_trained/model_path
...
TRAINING_SIZE = 101 # size of the training set
...
pref_rotation = True # If True, the testing set will be augmented with the rotations such that the main direction of the images is vertical.
