...
from util import make_img_overlay, label_to_img, img_crop, value_to_class_2, extract_test
...
# ----------------------------
if resize == True:
    test_data = extract_test(test_data_dir, TESTING_SIZE,augmentation=False, train=False, resize=resize)
else:
...
for num in range(0,TESTING_SIZE):
    ...
    pred_patches = img_crop(mask, 16, 16)
    ...
    if resize == True:
        ...
        oimg.save(path_saved_pred+"overlay_patches_pred"+str(num)+".png")
    else:
