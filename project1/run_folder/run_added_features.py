...
def eliminate_columns(df):
    #jets = []
    #for i in range(4):
    #    jets.append(df[split_jets_mask(df)[i]])
    #jet_num_column = [22] # columns with the info to split in jets
    phis_column = [15,18,20,25,28] # columns with the phis
    #columns_to_drop_jet0 = [4,5,6,12,23,24,25,26,27,28,29] # columns of nans
    #columns_to_drop_jet1 = [4,5,6,12,26,27,28] # columns of nans
...
name = 'output/ridge_regression_gauss.csv'
